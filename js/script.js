...
(function(w) {
    ...
    */
    var canvas_width = 4000; //Needs to be a multiple of the resolution value below.
    var canvas_height = 4000; //This too.
    
    var resolution = 100; //Width and height of each cell in the grid.
